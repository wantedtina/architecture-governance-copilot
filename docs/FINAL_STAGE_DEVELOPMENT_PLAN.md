...
acceptance criteria, or scheduling.
...
Historical session context is retained in the [handoff archive](archive/README.md).
Archived handoffs are not current planning or implementation-status documents.

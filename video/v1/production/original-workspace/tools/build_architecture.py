...
box(55,336,260,144,'#fff','#d8e2ec');t(77,374,['Project Team'],25,'#061d33',700);t(77,414,['Draft preparation','Action follow-through'],19,'#33576e')
box(55,510,260,144,'#fff','#d8e2ec');t(77,548,['Domain Architect'],25,'#061d33',700);t(77,588,['Architecture review','Formal decision authority'],19,'#33576e')
...
for y,title,lines in [(335,'Confluence',['Read-only templates + SI']),(450,'AIF provider',['Scoped AI requests']),(621,'Azure DevOps',['Repos + Boards','Controlled work items'])]:
...
for y,title,lines in [(328,'Confluence',['Read API · authoritative SI','Users edit in Confluence UI']),(450,'AI Factory (AIF)',['Confirmed context in','Structured proposal out']),(588,'Azure Repos API',['Selected repository + revision']),(684,'Azure Boards API',['Governance metadata + work items'])]:
...
box(355,890,955,107,'#0b2a40','#527d9b');t(382,927,['Enterprise controls'],24,'#fff',700);t(382,963,['Role-based permissions · secrets · encryption · data policy'],22,'#c7d8e5')

...
assert Path('export/FORM_TEXT.md').read_bytes()==Path('/Users/wantedtina/Deliverables/architecture-governance-copilot/2026-09-14-v2.1/export/FORM_TEXT.md').read_bytes()

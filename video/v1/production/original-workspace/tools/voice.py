...
subprocess.run([FF,'-y','-loglevel','error','-f','concat','-safe','0','-i','audio/concat.txt','-af','loudnorm=I=-16:TP=-1.5:LRA=11','-ar','48000','-c:a','pcm_s16le','audio/narration-v2.2.wav'],check=True)
